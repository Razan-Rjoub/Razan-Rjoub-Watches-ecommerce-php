...
$selectQuery = "SELECT * FROM `orderitem` WHERE orderid = :order_id";
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $deleteQuery = "DELETE FROM `orderitem` WHERE `id`= :id";
                                ...
                                <table class="table table-dark">
                                    ...
                                    <?php foreach ($orderitems as $orderitem): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $orderitem['orderid']; ?>
                                            </td>
                                            <td>
                                                <?php echo $orderitem['productid']; ?>
                                            </td>
                                            <td class="d-flex flex-row">
                                                <a class='btn btn-danger btn-sm m-1'
                                                    href='order-item-view.php?id=<?php echo $orderitem['id']; ?>'>Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </table>
