...
<body class="animsition">
	...
	<?php include '../cozastore-master/nav.php' ?><!-- navbar -->
	...
	<div class="sec-banner bg0 p-t-80 p-b-50">
		<div class="container">
			<h2 style="text-align: center;margin-bottom:50px">Categorys</h2>
			<div class="row">
...
WHERE wishlist.customerid = $user"; //from session or cookies get the id
