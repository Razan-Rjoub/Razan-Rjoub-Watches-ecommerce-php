...
<body class="animsition">
					...
					<div style="margin:auto" class="col-md-6 col-lg-4 p-b-30">
						...
						<div class="block1 position-relative">
							<div class="wrap-pic-w">
								<a href="product.php" class="block1-img-link">
								...
								<a href="product.php" class="block1-txt d-flex flex-column justify-content-between p-4">
	...
	<?php include '../cozastore-master/footer.php' ?>
