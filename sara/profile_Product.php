...
$query_select_order_itemsid = "SELECT id FROM `order item` WHERE orderid = :orderid";
$stmt_select_order_itemsid = $pdo->prepare($query_select_order_items);
$stmt_select_order_itemsid->bindParam(':orderid', $orderid, PDO::PARAM_INT);
$stmt_select_order_itemsid->execute();
$row_order_itemid = $stmt_select_order_itemsid->fetchAll(PDO::FETCH_ASSOC);
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <table id="data_table"
                                                                            ...
                                                                            <thead>
                                                                                <tr role="row">
                                                                                    ...
                                                                                    <th class="sorting_asc" tabindex="0"
                                                                                        aria-controls="data_table"
                                                                                        rowspan="1" colspan="1"
                                                                                        aria-label="Product Price: activate to sort column descending"
                                                                                        style="width: 38.575px;"
                                                                                        aria-sort="ascending">
                                                                                         Product Price
                                                                                    </th>
                                                                                    <th class="sorting_asc" tabindex="0"
                                                                                        aria-controls="data_table"
                                                                                        rowspan="1" colspan="1"
                                                                                        aria-label="Product Color: activate to sort column descending"
                                                                                        style="width: 38.575px;"
                                                                                        aria-sort="ascending">
                                                                                        Product Color
                                                                                    </th>
                                                                            ...
                                                                            <tbody> 
                                                                                  <?php while ($row_order_item = $stmt_select_order_items->fetch(PDO::FETCH_ASSOC)) {
                                                                                    $productid = $row_order_item['productid'];
                                                                                    $order_item_id = $row_order_item['id'];

                                                                                    
                                                                                    

                                                                                    $query_select_product = "SELECT * FROM `product` WHERE id = :productid";
                                                                                    $stmt_select_product = $pdo->prepare($query_select_product);
                                                                                    $stmt_select_product->bindParam(':productid', $productid, PDO::PARAM_INT);
                                                                                    $stmt_select_product->execute();
                                                                                    while($row_product = $stmt_select_product->fetch(PDO::FETCH_ASSOC)){
                                                                                ?>
                                                                                    <tr>
                                                                                        <td><?php echo $row_product['Productname']; ?></td>
                                                                                        <td><?php echo $row_product['price']; ?></td>
                                                                                        <td><?php echo $row_product['color']; ?></td>
                                                                                        <td><?php echo $row_product['stockqty']; ?></td>
                                                                                        <td><?php echo $row_product['description']; ?></td>
                                                                                        <td>
                                                                                            <div class="table-actions">
                                                                                             
                                                                                                <a href="update_product.php?order_item_id=<?php echo ($order_item_id)?>"><i class="ik ik-trash-2"></i></a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                <?php } ?>
