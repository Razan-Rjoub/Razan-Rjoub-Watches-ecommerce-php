                                                                        ...
                                                                        <table id="data_table"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <?php echo htmlspecialchars($row_use['firstname']); ?>
                                                                                    </td>
                                                                                    <td>
                                                                                        <?php echo htmlspecialchars($row_use['lastname']); ?>
                                                                                    </td>
                                                                                    <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="table-actions">
                                                                                            <a href="update_user.php" ><i class="ik ik-edit-2" id="showFormButton"></i></a>
                                                                                        </div>
                                                                                    </td>
