...
session_start();
$userid_session =  $_COOKIE['userid'];; // from session
                                                                        ...
                                                                        <table id="data_table"
                                                                            ...
                                                                            <?php if (is_array($shipments)) : ?>
                                                                                ...
                                                                                <tr role="row" class="odd">
                                                                                    ...
                                                                                    <td><?php echo $row_shipment['country']; ?></td>
                                                                                    <td><?php echo $row_shipment['city']; ?></td>
                                                                                    <td><?php echo $row_shipment['address']; ?></td>
                                                                                    <td>
                                                                                        <div class="table-actions">
                                                                                            <a href="updata_shipment.php?id=<?php echo $row_shipment['id']; ?>"><i class="ik ik-edit-2"></i></a>
                                                                                            <a href="Profile_delet_shipment.php?id=<?php echo $row_shipment['id']; ?>"><i class="ik ik-trash-2"></i></a>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            <?php endforeach; ?>
