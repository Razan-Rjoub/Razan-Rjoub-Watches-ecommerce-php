                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <table id="data_table"
                                                                            ...
                                                                            <thead>
                                                                                <tr role="row">
                                                                                    ...
                                                                                    <th class="sorting_asc" tabindex="0"
                                                                                        aria-controls="data_table"
                                                                                        rowspan="1" colspan="1"
                                                                                        aria-label="Product Pricee: activate to sort column descending"
                                                                                        style="width: 38.575px;"
                                                                                        aria-sort="ascending">
                                                                                         Product Price
                                                                                    </th>
                                                                            ...
                                                                            <?php while ($row_wishlist = $stmt_select_wishlist->fetch(PDO::FETCH_ASSOC)) {
                                                                                ...
                                                                                ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <!-- <td><?php echo $row_product['image']; ?></td> -->
                                                                                        <td>
                                                                                            <div class="table-actions">
                                                                                                <!-- <a href="Order_item.php?id=<?php echo $row_product['id']; ?>"><i class="ik ik-eye"></i></a> -->
                                                                                                <!-- <a href="Order_item.php?id=<?php echo $row_product['id']; ?>"><i class="ik ik-edit-2"></i></a> -->
                                                                                                <a href="profile_delet_wishlist.php?id=<?php echo $row_product['id']; ?>"><i class="ik ik-trash-2"></i></a>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                <?php } ?>
