...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   $shipmentId = $_POST["shipmentid"];
    ...
    // Update query
    $query_update_shipment = "UPDATE `shipment` SET country = :new_country, city = :new_city, address = :new_address WHERE id = :shipment_id";
    $stmt_update_shipment = $pdo->prepare($query_update_shipment);
    $stmt_update_shipment->bindParam(':new_country', $newCountry, PDO::PARAM_STR);
    $stmt_update_shipment->bindParam(':new_city', $newCity, PDO::PARAM_STR);
    $stmt_update_shipment->bindParam(':new_address', $newAddress, PDO::PARAM_STR);
    $stmt_update_shipment->bindParam(':shipment_id', $shipmentId, PDO::PARAM_INT);
...
$shipments = $stmt_select_shipment->fetchAll(PDO::FETCH_ASSOC);
?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <table id="data_table"
                                                                            ...
                                                                            <thead>
                                                                                <tr role="row">
                                                                                    ...
                                                                                    <th class="sorting_asc" tabindex="0"
                                                                                        aria-controls="data_table"
                                                                                        rowspan="1" colspan="1"
                                                                                        aria-label="Country: activate to sort column descending"
                                                                                        style="width: 38.575px;"
                                                                                        aria-sort="ascending">
                                                                                        Country
                                                                                    </th>
                                                                            ...
                                                                            <?php if (is_array($shipments)) : ?>
                                                                                <?php foreach ($shipments as $row_shipment) : ?>
                                                                                    <tr role="row" class="odd">
                                                                                        <form action="updata_shipment.php" method="post"> <!-- Assuming the update logic will be in "Profile_update_shipment.php" -->
                                                                                            <input type="hidden" name="shipmentid" value="<?php echo $row_shipment['id']; ?>">
                                                                                            <td class="sorting_1"><?php echo $row_shipment['Shipmentdate']; ?></td>
                                                                                            <td><input type="text" name="country" value="<?php echo $row_shipment['country']; ?>"></td>
                                                                                            <td><input type="text" name="city" value="<?php echo $row_shipment['city']; ?>"></td>
                                                                                            <td><input type="text" name="address" value="<?php echo $row_shipment['address']; ?>"></td>
                                                                                            <td>
                                                                                                <div class="table-actions">
                                                                                                     <!-- Use a button for updating -->
                                                                            ...
                                                                            <?php else : ?>
                                                                                <tr class="text-center">
                                                                                    <td colspan="5" style="font-size: 18px;">No shipment</td>
                                                                                </tr>
                                                                            <?php endif; ?>
