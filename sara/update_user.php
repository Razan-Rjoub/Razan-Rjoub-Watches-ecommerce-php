                                                                                ...
                                                                                <tr>
                                                                                    <form method="post" action="update_user.php"> <!-- Point this to the PHP script handling updates -->
                                                                                        ...
                                                                                        <td class="sorting_1">
                                                                                            ...
                                                                                            <input type="text" name="Username" value="<?php echo $row_use['Username']; ?>">
                                                                                        </td>
                                                                                        <td class="sorting_1">
                                                                                            <input type="text" name="firstname" value="<?php echo htmlspecialchars($row_use['firstname']); ?>">
                                                                                        </td>
                                                                                        <td class="sorting_1">
                                                                                            <input type="text" name="lastname" value="<?php echo htmlspecialchars($row_use['lastname']); ?>">
                                                                                        </td>
                                                                                        <td class="sorting_1">
